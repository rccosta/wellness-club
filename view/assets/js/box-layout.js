...
$(document).ready(function() {
    ...
    var Navbarbg = "themelight1";           //  navbar color                themelight1 / theme4
    var headerbg = "theme4";                //  header color                theme4 / theme2 / theme3 / theme4 / theme5 / theme6
    var menucaption = "theme4";             //  menu caption color          theme4 / theme2 / theme3 / theme4 / theme5 / theme6 / theme7 / theme8 / theme9
    var bgpattern = "theme4";               //  background color            theme4 / theme2 / theme3 / theme4 / theme5 / theme6
    var activeitemtheme = "theme4";         //  menu active color           theme4 / theme2 / theme3 / theme4 / theme5 / theme6 / theme7 / theme8 / theme9 / theme40 / theme41 / theme42
    var frametype = "theme4";               //  preset frame color          theme4 / theme2 / theme3 / theme4 / theme5 / theme6
    ...
    function handlelayouttheme() {
        $('.theme-color > a.Layout-type').on("click", function() {
            ...
            if (layout == 'dark') {
                ...
                $('.pcoded-navbar').attr("navbar-theme", "theme4");
                $('.pcoded-navbar').attr("active-item-theme", "theme4");
                $('.pcoded').attr("fream-type", "theme4");
                $('body').addClass('dark');
                $('body').attr("themebg-pattern", "theme4");
                $('.pcoded-navigation-label').attr("menu-title-theme", "theme9");
                setCookie("header-theme", "theme4", noofdays);
                setCookie("NavbarBackground", "theme4", noofdays);
                setCookie("menu-title-theme", "theme4", noofdays);
                setCookie("themebg-pattern", "theme4", noofdays);
                setCookie("fream-type", "theme4", noofdays);
                setCookie("active-item-theme", "theme4", noofdays);
            }
            if (layout == 'light') {
                $('.pcoded-header').attr("header-theme", "theme4");
                $('.pcoded-navbar').attr("navbar-theme", "themelight1");
                $('.pcoded-navigation-label').attr("menu-title-theme", "theme4");
                $('.pcoded-navbar').attr("active-item-theme", "theme4");
                $('.pcoded').attr("fream-type", "theme4");
